...
def save_W_estimate(hist, path = 'W_estimate.png'):
    x = range(len(hist['D_losses']))
...
for epoch in range(epochs):
    ...
    W_estimate = torch.mean(torch.FloatTensor(D_losses))
    ...
    train_hist['W_estimate'].append(W_estimate)
...
save_W_estimate(train_hist, path = dir + '/W_estimate.png')
